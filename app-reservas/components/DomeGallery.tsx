...
const DEFAULT_IMAGES: ImageItem[] = [
  { src: "/images/domes/dome_forest.jpg", alt: "Domo en el Bosque", label: "Bosque", badge: "Aventura" },
  { src: "/images/domes/dome_snow.jpg", alt: "Domo en la Nieve", label: "Islandia", badge: "Invierno" },
  { src: "/images/domes/dome_night.jpg", alt: "Domo Bajo las Estrellas", label: "Desierto", badge: "Estelar" },
  { src: "/images/domes/dome_luxury.jpg", alt: "Domo de Lujo frente al Mar", label: "Playa", badge: "Premium" },
  { src: "/images/domes/dome_interior.jpg", alt: "Interior del Domo", label: "Interior", badge: "Confort" }
];
...
const toPointerKind = (value: string | undefined): PointerKind => {
  if (value === "pen" || value === "touch") {
    return value;
  }
  return "mouse";
};
...
// Calcula la rotación base de cada tile
...
export default function DomeGallery({
  ...
  // Referencias para rotación y drag
  ...
  useEffect(() => {
    ...
    const ro = new ResizeObserver((entries) => {
      ...
      // Ajusta overlay de imagen ampliada
  ...
  // Efecto de auto-rotación
  useEffect(() => {
    let animId: number;

    const step = () => {
      // Rota solo cuando no hay interacción ni ampliación ni hover pausado
      if (
        !draggingRef.current &&
        !openingRef.current &&
  ...
  // Inercia del giro al soltar drag
  ...
  useGesture(
    {
      onDragStart: ({ event }) => {
        ...
        pointerTypeRef.current = toPointerKind(evt.pointerType);
  ...
  // Limpia scroll-lock al desmontar
  useEffect(() => {
    return () => {
      document.body.classList.remove("dg-scroll-lock");
    };
  ...
  const sphereRootStyle: CssVarStyle = {
    "--segments-x": segments,
    "--segments-y": segments,
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Overlays y scrim para efectos de luz */}
          <div
          ...
          {/* Viewer y scrim para imagen ampliada */}
          <div
            ref={viewerRef}
